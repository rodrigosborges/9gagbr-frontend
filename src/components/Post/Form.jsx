...
export default class Form extends React.Component {
    ...
    _getPost(){
        axios.get('http://'+(process.env.SERVER ? process.env.SERVER : 'localhost:3001')+'/post/find/'+this.props.id)
        .then((res) => {
        ...
        if(this._formValidate()){
            ...
            if(this.props.id != null){
                var request = axios.put(
                    'http://'+(process.env.SERVER ? process.env.SERVER : 'localhost:3001')+'/post/'+this.props.id, 
                    {
                ...
                var request = axios.post(
                    'http://'+(process.env.SERVER ? process.env.SERVER : 'localhost:3001')+'/post/', 
                    data,
